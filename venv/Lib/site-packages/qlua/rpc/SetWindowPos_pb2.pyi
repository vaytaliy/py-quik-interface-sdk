...
class Args(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        ...
        dx : typing___Optional[builtin___int] = None,
        dy : typing___Optional[builtin___int] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"dx",b"dx",u"dy",b"dy",u"t_id",b"t_id",u"x",b"x",u"y",b"y"]) -> None: ...
type___Args = Args
